...
def mp4_to_gif(mp4_folder, gif_folder, scale):
    ...
    for mp4_file in mp4_files:
        ...
        video_clip.resize((gif_width, gif_height)).write_gif(gif_path)
...
if __name__ == "__main__":
    ...
    mp4_to_gif(args.mp4_folder, args.gif_folder, args.scale)